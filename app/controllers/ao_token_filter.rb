module AOTokenFilter
  ...
  def log_and_redirect(controller, token_state)
  ...
  def log_error(token_state, params)
    LogStuff.error(
      :token_error,
  ...
  def extract_user_name(controller)
