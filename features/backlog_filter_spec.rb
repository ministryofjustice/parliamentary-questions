...
describe "'Backlog' page filtering:", js: true, suspend_cleaner: true do
  ...
  def setup_questions
    pq01 = FactoryBot.create(:with_pod_pq, uin: "UIN-1", date_for_answer: Time.zone.today - 1, internal_deadline: Time.zone.today - 2, minister_id: 3, policy_minister_id: 6, question_type: "NamedDay")
    pq02 = FactoryBot.create(:draft_pending_pq, uin: "UIN-2", date_for_answer: Time.zone.today - 2, internal_deadline: Time.zone.today - 3, minister_id: 3, policy_minister_id: 4, question_type: "NamedDay")
    pq03 = FactoryBot.create(:with_pod_pq, uin: "UIN-3", date_for_answer: Time.zone.today - 3, internal_deadline: Time.zone.today - 4, minister_id: 3, policy_minister_id: 4, question_type: "Ordinary")
    pq04 = FactoryBot.create(:with_pod_pq, uin: "UIN-4", date_for_answer: Time.zone.today - 4, internal_deadline: Time.zone.today - 5, minister_id: 5, policy_minister_id: 4, question_type: "NamedDay")
    pq05 = FactoryBot.create(:draft_pending_pq, uin: "UIN-5", date_for_answer: Time.zone.today - 5, internal_deadline: Time.zone.today - 6, minister_id: 5, policy_minister_id: 4, question_type: "Ordinary")
    pq06 = FactoryBot.create(:with_pod_pq, uin: "UIN-6", date_for_answer: Time.zone.today - 6, internal_deadline: Time.zone.today - 7, minister_id: 3, policy_minister_id: 4, question_type: "NamedDay")
    pq07 = FactoryBot.create(:with_pod_pq, uin: "UIN-7", date_for_answer: Time.zone.today - 7, internal_deadline: Time.zone.today - 8, minister_id: 5, policy_minister_id: 6, question_type: "Ordinary")
    pq08 = FactoryBot.create(:draft_pending_pq, uin: "UIN-8", date_for_answer: Time.zone.today - 8, internal_deadline: Time.zone.today - 9, minister_id: 3, policy_minister_id: 6, question_type: "Ordinary")
    pq09 = FactoryBot.create(:draft_pending_pq, uin: "UIN-9", date_for_answer: Time.zone.today - 9, internal_deadline: Time.zone.today - 10, minister_id: 5, policy_minister_id: 6, question_type: "Ordinary")
