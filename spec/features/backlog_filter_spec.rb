...
describe "'Backlog' page filtering:", :js do
  before do
    setup_questions
    create_pq_session
  ...
  def setup_questions
    ...
    @pq1 = FactoryBot.create(:with_pod_pq, uin: "UIN-1", date_for_answer: Time.zone.today - 1, internal_deadline: Time.zone.today - 2, minister_id: 3, policy_minister_id: 6, question_type: "NamedDay")
    @pq2 = FactoryBot.create(:draft_pending_pq, uin: "UIN-2", date_for_answer: Time.zone.today - 2, internal_deadline: Time.zone.today - 3, minister_id: 3, policy_minister_id: 4, question_type: "NamedDay")
    @pq3 = FactoryBot.create(:with_pod_pq, uin: "UIN-3", date_for_answer: Time.zone.today - 3, internal_deadline: Time.zone.today - 4, minister_id: 3, policy_minister_id: 4, question_type: "Ordinary")
    @pq4 = FactoryBot.create(:with_pod_pq, uin: "UIN-4", date_for_answer: Time.zone.today - 4, internal_deadline: Time.zone.today - 5, minister_id: 5, policy_minister_id: 4, question_type: "NamedDay")
    @pq5 = FactoryBot.create(:draft_pending_pq, uin: "UIN-5", date_for_answer: Time.zone.today - 5, internal_deadline: Time.zone.today - 6, minister_id: 5, policy_minister_id: 4, question_type: "Ordinary")
    @pq6 = FactoryBot.create(:with_pod_pq, uin: "UIN-6", date_for_answer: Time.zone.today - 6, internal_deadline: Time.zone.today - 7, minister_id: 3, policy_minister_id: 4, question_type: "NamedDay")
    @pq7 = FactoryBot.create(:with_pod_pq, uin: "UIN-7", date_for_answer: Time.zone.today - 7, internal_deadline: Time.zone.today - 8, minister_id: 5, policy_minister_id: 6, question_type: "Ordinary")
    @pq8 = FactoryBot.create(:draft_pending_pq, uin: "UIN-8", date_for_answer: Time.zone.today - 8, internal_deadline: Time.zone.today - 9, minister_id: 3, policy_minister_id: 6, question_type: "Ordinary")
    @pq9 = FactoryBot.create(:draft_pending_pq, uin: "UIN-9", date_for_answer: Time.zone.today - 9, internal_deadline: Time.zone.today - 10, minister_id: 5, policy_minister_id: 6, question_type: "Ordinary")
    @pq10 = FactoryBot.create(:with_pod_pq, uin: "UIN-10", date_for_answer: Time.zone.today - 10, internal_deadline: Time.zone.today - 11, minister_id: 5, policy_minister_id: 4, question_type: "Ordinary")
    @pq11 = FactoryBot.create(:with_pod_pq, uin: "UIN-11", date_for_answer: Time.zone.today - 11, internal_deadline: Time.zone.today - 12, minister_id: 3, policy_minister_id: 6, question_type: "Ordinary")
    @pq12 = FactoryBot.create(:draft_pending_pq, uin: "UIN-12", date_for_answer: Time.zone.today - 12, internal_deadline: Time.zone.today - 13, minister_id: 5, policy_minister_id: 4, question_type: "NamedDay")
    @pq13 = FactoryBot.create(:draft_pending_pq, uin: "UIN-13", date_for_answer: Time.zone.today - 13, internal_deadline: Time.zone.today - 14, minister_id: 5, policy_minister_id: 6, question_type: "NamedDay")
    @pq14 = FactoryBot.create(:draft_pending_pq, uin: "UIN-14", date_for_answer: Time.zone.today - 14, internal_deadline: Time.zone.today - 15, minister_id: 3, policy_minister_id: 4, question_type: "Ordinary")
    @pq15 = FactoryBot.create(:with_pod_pq, uin: "UIN-15", date_for_answer: Time.zone.today - 15, internal_deadline: Time.zone.today - 16, minister_id: 5, policy_minister_id: 6, question_type: "NamedDay")
    @pq16 = FactoryBot.create(:draft_pending_pq, uin: "UIN-16", date_for_answer: Time.zone.today - 16, internal_deadline: Time.zone.today - 17, minister_id: 3, policy_minister_id: 6, question_type: "NamedDay")
  end
end
