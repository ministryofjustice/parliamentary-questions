...
def create_directorates
  FactoryBot.create(:directorate, name: "Directorate A", updated_at: Time.zone.now.to_datetime, deleted: false)
  FactoryBot.create(:directorate, name: "Directorate B", updated_at: Time.zone.now.to_datetime, deleted: true)
  ...
  FactoryBot.create(:directorate, name: "Directorate G", updated_at: Time.zone.now.to_datetime, deleted: false)
  FactoryBot.create(:directorate, name: "Directorate H", updated_at: Time.zone.now.to_datetime, deleted: true)
