...
def create_ministers
  FactoryBot.create(:minister, name: 'Anna Maddox',       updated_at: DateTime.now.to_datetime, deleted: false)
  FactoryBot.create(:minister, name: 'Evangeline Cowan',  updated_at: DateTime.now.to_datetime, deleted: true)
  ...
  FactoryBot.create(:minister, name: 'Carrie Carroll',    updated_at: 2.days.ago.to_datetime,   deleted: false)
  FactoryBot.create(:minister, name: 'Armand Reid',       updated_at: 2.days.ago.to_datetime,   deleted: true)
  FactoryBot.create(:minister, name: 'Cecelia Barr',      updated_at: DateTime.now.to_datetime, deleted: false)
  FactoryBot.create(:minister, name: 'Xavier Freeman',    updated_at: DateTime.now.to_datetime, deleted: true)
  ...
  FactoryBot.create(:minister, name: 'Bill Estes',        updated_at: 2.days.ago.to_datetime,   deleted: false)
  FactoryBot.create(:minister, name: 'Jeramy Conner',     updated_at: 2.days.ago.to_datetime,   deleted: true)
end
