...
def create_press_officers
  FactoryBot.create(:press_officer, name: "Anna Maddox",      updated_at: Time.zone.now.to_datetime, deleted: false)
  FactoryBot.create(:press_officer, name: "Evangeline Cowan", updated_at: Time.zone.now.to_datetime, deleted: true)
  ...
  FactoryBot.create(:press_officer, name: "Cecelia Barr",     updated_at: Time.zone.now.to_datetime, deleted: false)
  FactoryBot.create(:press_officer, name: "Xavier Freeman",   updated_at: Time.zone.now.to_datetime, deleted: true)
