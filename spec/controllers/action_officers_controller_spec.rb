...
describe ActionOfficersController, type: :controller do
  describe 'Get index' do
    ...
    let! (:ao_1) {create :action_officer, name: 'Anna Maddox',        deputy_director_id: '1', updated_at: DateTime.now.to_datetime,  deleted: false}
    let! (:ao_2) {create :action_officer, name: 'Evangeline Cowan',   deputy_director_id: '2', updated_at: DateTime.now.to_datetime,  deleted: true}
    let! (:ao_3) {create :action_officer, name: 'Lisa May',           deputy_director_id: '2', updated_at: 1.day.ago.to_datetime,     deleted: false}
    let! (:ao_4) {create :action_officer, name: 'Sylvia Ware',        deputy_director_id: '1', updated_at: 1.day.ago.to_datetime,     deleted: true}
    let! (:ao_5) {create :action_officer, name: 'Carrie Carroll',     deputy_director_id: '2', updated_at: 2.days.ago.to_datetime,    deleted: false}
    let! (:ao_6) {create :action_officer, name: 'Armand Reid',        deputy_director_id: '1', updated_at: 2.days.ago.to_datetime,    deleted: true}
    let! (:ao_7) {create :action_officer, name: 'Cecelia Barr',       deputy_director_id: '1', updated_at: DateTime.now.to_datetime,  deleted: false}
    let! (:ao_8) {create :action_officer, name: 'Xavier Freeman',     deputy_director_id: '2', updated_at: DateTime.now.to_datetime,  deleted: true}
    let! (:ao_9) {create :action_officer, name: 'Kent Holloway',      deputy_director_id: '2', updated_at: 1.day.ago.to_datetime,     deleted: false}
    let! (:ao_10) {create :action_officer, name: 'Jae Young',         deputy_director_id: '1', updated_at: 1.day.ago.to_datetime,     deleted: true}
    let! (:ao_11) {create :action_officer, name: 'Bill Estes',        deputy_director_id: '1', updated_at: 2.days.ago.to_datetime,    deleted: false}
    let! (:ao_12) {create :action_officer, name: 'Jeramy Conner',     deputy_director_id: '1', updated_at: 2.days.ago.to_datetime,    deleted: true}

    let! (:dd_1) {create :deputy_director, name: 'Randi Harding',      division_id: '2'}
    let! (:dd_2) {create :deputy_director, name: 'Ernestine Santana',  division_id: '1'}
