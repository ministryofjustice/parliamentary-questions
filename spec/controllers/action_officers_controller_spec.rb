...
def create_action_officers
  FactoryBot.create(:action_officer, name: "Anna Maddox",       deputy_director_id: "1", updated_at: Time.zone.now.to_datetime, deleted: false)
  FactoryBot.create(:action_officer, name: "Evangeline Cowan",  deputy_director_id: "2", updated_at: Time.zone.now.to_datetime, deleted: true)
  ...
  FactoryBot.create(:action_officer, name: "Cecelia Barr",      deputy_director_id: "1", updated_at: Time.zone.now.to_datetime, deleted: false)
  FactoryBot.create(:action_officer, name: "Xavier Freeman",    deputy_director_id: "2", updated_at: Time.zone.now.to_datetime, deleted: true)
