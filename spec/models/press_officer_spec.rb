...
describe PressOfficer do
  ...
  describe "Get index" do
    let!(:pressOfficer1) { create(:press_officer, updated_at: Time.zone.now.to_datetime, deleted: false) }
    let!(:pressOfficer2) { create(:press_officer, updated_at: Time.zone.now.to_datetime, deleted: true) }
