module PQState
  ...
  NEW = [UNASSIGNED, NO_RESPONSE, REJECTED]

  IN_PROGRESS = [DRAFT_PENDING, WITH_POD, POD_QUERY, POD_CLEARED, WITH_MINISTER, MINISTERIAL_QUERY, MINISTER_CLEARED]

  CLOSED = [ANSWERED, TRANSFERRED_OUT]
